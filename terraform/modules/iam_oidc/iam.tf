# /terraform/modules/iam_oidc/iam.tf
    ...
    Statement = [
      {
        ...
        Condition = {
          StringLike = {
            ...
            #"token.actions.githubusercontent.com:sub" = "repo:kamotaka-0426/membership_blog_on_ecs:*"
...
# Permissions required to update ECS service and register task definitions
...
resource "aws_iam_role_policy" "github_actions_s3_accesss" {
